 ...
 * Cleaned and improved algorithm from {@link http://www.cs.huji.ac.il/~omrif01/Strassen}.
 * <p/>
 *
 * @author pmar
 */
public class StrassenMatrixMultiplication {
     ...
     */
    public static double[][] reconstructMatrix(double[][] r, double[][] s, double[][] t, double[][] u) {
     ...
     */
    public static void copyBack(double[][] destination, double[][] r, int x, int y) {
