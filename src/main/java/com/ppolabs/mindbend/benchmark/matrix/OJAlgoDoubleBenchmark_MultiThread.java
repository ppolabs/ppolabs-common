...
public class OJAlgoDoubleBenchmark_MultiThread implements Benchmark {

    private final String name;
    private final VirtualMachine virtualMachine;

    public OJAlgoDoubleBenchmark_MultiThread() {
        this.name = "ojAlgo matrix multiplication, DOUBLE precision, multi-threaded";
